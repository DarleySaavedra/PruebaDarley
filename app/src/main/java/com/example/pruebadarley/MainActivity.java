...
public class MainActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextEmail = (EditText) findViewById(R.id.tuser);
        TextPassword = (EditText) findViewById(R.id.tpass);

        btnRegistrar = (Button) findViewById(R.id.bnew);
        btnLogin = (Button) findViewById(R.id.bingresar);
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(Task<AuthResult> task) {
                        ...
                        if (task.isSuccessful()) {
                            ...
                            intencion.putExtra(WellcomeActivity.user, email);
